...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public struct InputDevice : IEquatable<InputDevice>
    {
        ...
        public XRInputSubsystem subsystem { get; set; }
        ...
        // The name of the device in the XR system. This is a platform provided unique identifier for the device.
        public string name { get; set; }

        // This is a platform provided description of how the device is used.
        public XR.InputDeviceRole role { get; set; }

        // A bitmask of enumerated flags describing the characteristics of this InputDevice.
        public InputDeviceCharacteristics characteristics { get; set; }

        // True if the device is currently a valid input device; otherwise false.
        public bool isValid { get; set; }

        // The device's primary 2D axis value.
        public Vector2 primary2DAxis { get; set; }

        // The device's primary 2D axis touch value.
        public bool primary2DAxisTouch { get; set; }

        // The device's primary 2D axis click value.
        public bool primary2DAxisClick { get; set; }

        // The device's trigger axis value.
        public float trigger { get; set; }

        // The device's trigger button value.
        public bool triggerButton { get; set; }

        // The device's grip axis value.
        public float grip { get; set; }

        // The device's grip button value.
        public bool gripButton { get; set; }

        // The device's primary button value.
        public bool primaryButton { get; set; }

        // The device's primary touch value.
        ...
        // Tries to get a Vector2 feature value.
        ...
        // Tries to get a bool feature value.
        public bool TryGetFeatureValue(InputFeatureUsage<bool> usage, out bool value)
        {
            ...
            switch (usage.name)
            {
                // Get the Primary2DAxisTouch.
                case "Primary2DAxisTouch":
                    valueGet = true;
                    value = primary2DAxisTouch;
                    break;

                // Get the Primary2DAxisClick.
                case "Primary2DAxisClick":
                    valueGet = true;
                    value = primary2DAxisClick;
                    break;

                // Get the TriggerButton.
                case "TriggerButton":
                    valueGet = true;
                    value = triggerButton;
                    break;
        ...
        //
        //   amplitude:
        //     The normalized (0.0 to 1.0) amplitude value of the haptic impulse to play on
        //     the device.
        //
        //   duration:
        //     The duration in seconds that the haptic impulse will play. Only supported on
        //     Oculus.
        //
        // Returns:
        //     Returns true if successful. Returns false otherwise.
        ...
        {
            capabilities = new HapticCapabilities();
            return false;
        }
